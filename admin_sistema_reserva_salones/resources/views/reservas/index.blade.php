...
<!-- Barra de Búsqueda -->
<div class="filter-bar animate-fadeInUp" style="animation-delay: 0.05s;">
    <div class="flex flex-col md:flex-row items-center gap-4">
        <div class="relative w-full md:w-1/2">
            <input
                id="search-input"
                type="text"
                placeholder="Buscar por id, cliente o salón..."
                class="pl-10 pr-4 py-2 rounded-lg bg-white/10 border border-white/30 text-white placeholder-white/50 
                       focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/50 backdrop-blur-sm
