<x-app-layout>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0s;">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-emerald-300">{{ $stats['salones_activos'] }}</p>
                ...
                <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.1s;">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-yellow-300">{{ $stats['reservas_pendientes'] }}</p>
                ...
                <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.2s;">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-green-300">{{ $stats['reservas_hoy'] }}</p>
                ...
                <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.3s;">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-blue-300">${{ number_format($stats['ingresos_mes'], 0) }}</p>
    ...
    <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.4s;">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold text-purple-300">{{ $stats['clientes_registrados'] }}</p>
                <div class="flex items-center text-purple-400 text-sm">
                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3-9a1 1 0 01-1-1H8a1 1 0 01-1 1v4a1 1 0 011 1h4a1 1 0 011-1V9z" clip-rule="evenodd"/>
                    </svg>
                    Usuarios
                </div>
            </div>
        </div>
        <h3 class="text-lg font-semibold text-purple-100">Clientes Registrados</h3>
        <p class="text-purple-200/70 text-sm mt-1">Usuarios con cuenta activa</p>
    </div>
    {{-- MÉTRICA: Clientes Registrados --}}

    <!-- Salones en Mantenimiento -->
    <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.5s;">
        <div class="flex items-center justify-between mb-4">
            <div class="p-3 rounded-xl bg-orange-500/20 border border-orange-400/30">
                <svg class="w-8 h-8 text-orange-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 21h6l-.75-4M12 3v4m0 0a4 4 0 014 4v4a4 4 0 01-4 4 4 4 0 01-4-4V11a4 4 0 014-4z"/>
                </svg>
            </div>
            <div class="text-right">
                <p class="text-3xl font-bold text-orange-300">{{ $stats['salones_mantenimiento'] }}</p>
        ...
        <h3 class="text-lg font-semibold text-orange-100">Salones en Mantenimiento</h3>
        <p class="text-orange-200/70 text-sm mt-1">No disponibles actualmente</p>
    </div>
    {{-- MÉTRICA: Salones en Mantenimiento --}}

    <!-- Reservas Canceladas este mes -->
    <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.6s;">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold text-red-300">{{ $stats['reservas_canceladas_mes'] }}</p>
        ...
        <h3 class="text-lg font-semibold text-red-100">Reservas Canceladas</h3>
        <p class="text-red-200/70 text-sm mt-1">En el mes actual</p>
    </div>
    {{-- MÉTRICA: Reservas Canceladas este mes --}}

    <!-- Porcentaje de Ocupación -->
    <div class="aurora-card aurora-stat-card rounded-2xl p-6 text-white animate-fadeInUp" style="animation-delay:0.7s;">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="text-right">
                <p class="text-3xl font-bold text-cyan-300">{{ $stats['porcentaje_ocupacion'] }}%</p>
        ...
        <h3 class="text-lg font-semibold text-cyan-100">Ocupación</h3>
        <p class="text-cyan-200/70 text-sm mt-1">Porcentaje de salones ocupados hoy</p>
    </div>
    {{-- MÉTRICA: Porcentaje de Ocupación --}}
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-emerald-300/70 text-sm">Cliente</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
            ...
            <!-- Salones populares -->
            <div class="aurora-card rounded-2xl p-6 animate-fadeInUp" style="animation-delay:0.5s;">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-2xl font-bold text-white flex items-center gap-3">
                        <div class="p-2 rounded-lg bg-emerald-500/20 border border-emerald-400/30">
                            <svg class="w-6 h-6 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        @foreach($salones_populares as $index => $salon)
                            <div class="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-emerald-500/10 to-green-500/10 border border-emerald-400/20 hover:border-emerald-400/40 transition-all duration-300 hover:transform hover:scale-[1.02]">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="text-right">
                                        <div class="text-2xl font-bold text-emerald-300">{{ $salon->reservas_count }}</div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <button class="aurora-card rounded-xl p-4 text-center hover:scale-105 transition-all duration-300 group">
                ...
                <button class="aurora-card rounded-xl p-4 text-center hover:scale-105 transition-all duration-300 group">
                    ...
                    <span class="text-white font-semibold">Clientes</span>
                </button>
    ...
    <script>
        // Sistema de partículas mejorado con efectos de aurora
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const animatedElements = document.querySelectorAll('.animate-fadeInUp, .animate-fadeInDown');
